...
const VideoPlayer = () => {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        axios
            .get(`https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=AIzaSyCl3eoqeF4CxLHaZHG01LfmMoZVfqCoozY`)
            .then(response => {
    ...
    async function createVideoInfo (video) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=snippet%2C%20statistics&id=${channelId}&key=AIzaSyCl3eoqeF4CxLHaZHG01LfmMoZVfqCoozY`)
